...
<body>
	...
	<div id="wrapper">
		<input type="button" value="글 작성" name="write" onclick="location.href='../bbs/writeform.html?type=hobbit'" style="float:right;">
		<br/>
		<table align="center" border="1" >
			...
			<c:choose>
				<c:when test="${empty hobbitbbs }">
					<tr>
						<td colspan="5">작성된 게시글이 없습니다.</td>
					</tr>
				</c:when>
				<c:otherwise>
					<c:forEach items="${hobbitbbs }" var="bbs">
		...
		<div align="center">
			<c:forEach var="page" begin="1" end="${COUNT}">
				<a href="../bbs/hobbitbbs.html?pageNo=${page }">${page }</a>
			</c:forEach>
